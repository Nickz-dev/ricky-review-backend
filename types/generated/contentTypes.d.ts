...
export interface ApiCasinoCategoryCasinoCategory
  extends Struct.CollectionTypeSchema {
  collectionName: 'casino_categories';
  info: {
    displayName: 'CasinoCategory';
    pluralName: 'casino-categories';
    singularName: 'casino-category';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiCasinoPageContentCasinoPageContent
  extends Struct.CollectionTypeSchema {
  collectionName: 'casino_page_contents';
  info: {
    displayName: 'Casino Page Content';
    pluralName: 'casino-page-contents';
    singularName: 'casino-page-content';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    anchors: Schema.Attribute.Component<'shared.anchor-link', true>;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::casino-page-content.casino-page-content'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiCasinoCasino extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    logo: Schema.Attribute.Media<
      ...
      true
    >;
    paymentMethods: Schema.Attribute.String;
    playUrl: Schema.Attribute.String;
    promo: Schema.Attribute.Relation<'oneToOne', 'api::promo.promo'>;
    promoBanner: Schema.Attribute.String;
    promoCode: Schema.Attribute.String;
    promoDescription: Schema.Attribute.String;
    providers: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    rating: Schema.Attribute.Decimal;
    reviewBlocks: Schema.Attribute.DynamicZone<
      [
        'shared.text-block',
        'shared.image-block',
...
export interface ApiFooterFooter extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    footer_link: Schema.Attribute.Relation<
      'oneToOne',
      'api::footer-link.footer-link'
    >;
...
export interface ApiGameGame extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::game.game'> &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
    provide: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiHeroSectionHeroSection extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    buttonType: Schema.Attribute.String;
...
export interface ApiModalContentModalContent
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    mirrorUrl: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    showMirrorButton: Schema.Attribute.Boolean;
    title: Schema.Attribute.String;
...
export interface ApiPageContenPageConten extends Struct.CollectionTypeSchema {
  collectionName: 'page_contens';
  info: {
    displayName: 'PageContent';
    pluralName: 'page-contens';
    singularName: 'page-conten';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiPromoPromo extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::promo.promo'> &
      Schema.Attribute.Private;
    promoAmount: Schema.Attribute.String;
    promoIcon: Schema.Attribute.String;
...
export interface ApiTrustBlockTrustBlock extends Struct.CollectionTypeSchema {
  collectionName: 'trust_blocks';
  info: {
    displayName: 'TrustBlock';
    pluralName: 'trust-blocks';
    singularName: 'trust-block';
  };
  options: {
    draftAndPublish: true;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::casino-category.casino-category': ApiCasinoCategoryCasinoCategory;
      'api::casino-page-content.casino-page-content': ApiCasinoPageContentCasinoPageContent;
      ...
      'api::page-conten.page-conten': ApiPageContenPageConten;
      'api::promo.promo': ApiPromoPromo;
      'api::trust-block.trust-block': ApiTrustBlockTrustBlock;
